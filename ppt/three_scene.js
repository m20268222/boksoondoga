/* ============================================
   복순도가 TIM504 IMP · Three.js 3D
   라이트 배경에 어두운 옹기 + 베이지 누룩 입자
   ============================================ */
...
(function () {
  ...
  function init() {
    ...
    const jarMat = new THREE.MeshStandardMaterial({
      color: 0x4a3826, roughness: 0.75, metalness: 0.1,
    });
    ...
    const rimMat = new THREE.MeshBasicMaterial({
      color: 0x8a7544, transparent: true, opacity: 0.5,
    });
